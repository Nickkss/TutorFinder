...
class Tutor(BaseModel):
    ...
    intro_video = models.FileField(_("Upload Intro Video"), upload_to="tutor_intro_videos/", blank=False, null=True)
    ...
    about_me = RichTextField(verbose_name=_("About Me"), blank=True, null=True)
    ...
    def get_absolute_url(self):
        return reverse("tutor:Tutor", kwargs={"pk": self.pk})
