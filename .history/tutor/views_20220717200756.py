...
class TutorsView(View):
    def filter_tutors(self, request):
        ...
        # Filter Charges
        charges_gte = int(get.get('charges_gte', 100))
        charges_lte = int(get.get('charges_lte', 5000))
        ...
        if new_tutors:#if any(days):
            return (new_tutors, new_days, (charges_gte, charges_lte))
        else:
            return (tutors, None, None)
